...
const normalizeCurrencyInput = (value: string) => {
  ...
  if (!digits) return '';
  const numeric = Math.min(Number(digits) / 100, 1_000_000);
...
const toDatabaseDate = (value: string) => {
  ...
  if (year < 2000 || year > currentYear + 5 || month < 1 || month > 12 || day < 1 || day > 31) {
    return null;
  }
    ...
    try {
      ...
      if (ocrData.amount !== undefined && ocrData.amount !== null) {
        ...
        if (Number.isFinite(numericAmount) && numericAmount >= 0) {
          setAmount(numericAmount.toFixed(2).replace('.', ','));
        }
      }
      ...
      Alert.alert('Leitura indisponível', message);
    } finally {
      setLoadingOCR(false);
    }
  };
...
const styles = StyleSheet.create({
  ...
  modeRow: { minHeight: 56, marginTop: 18, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: '#f8fafc', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  modeCopy: { flex: 1 },
  modeTitle: { fontSize: 14, fontWeight: '800', color: '#1e293b' },
  modeHint: { marginTop: 2, fontSize: 12, lineHeight: 17, color: '#64748b' },
  ocrBox: { marginHorizontal: 16, marginTop: 16, padding: 16, backgroundColor: '#eef2ff', borderRadius: 16, borderWidth: 1, borderColor: '#c7d2fe' },
  sectionTitle: { fontSize: 17, lineHeight: 23, fontWeight: '900', color: '#1e293b' },
  sectionHint: { marginTop: 4, fontSize: 12, lineHeight: 18, color: '#475569' },
  loadingBox: { minHeight: 96, alignItems: 'center', justifyContent: 'center' },
  loadingText: { marginTop: 10, color: '#4338ca', fontWeight: '700' },
  buttonRow: { flexDirection: 'row', gap: 10, marginTop: 14 },
  secondaryButton: { flex: 1, minHeight: 48, borderRadius: 12, backgroundColor: '#4338ca', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 12 },
  secondaryButtonText: { color: '#fff', fontWeight: '800', fontSize: 14 },
  form: { marginHorizontal: 16, marginTop: 16, padding: 18, backgroundColor: '#fff', borderRadius: 16 },
  inputLabel: { marginTop: 18, marginBottom: 7, fontSize: 13, lineHeight: 18, color: '#334155', fontWeight: '800' },
  input: { minHeight: 52, backgroundColor: '#f8fafc', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, color: '#0f172a', borderWidth: 1, borderColor: '#cbd5e1' },
  currencyInput: { minHeight: 52, flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8fafc', borderRadius: 10, borderWidth: 1, borderColor: '#cbd5e1', paddingLeft: 14 },
  currencyPrefix: { fontSize: 16, fontWeight: '800', color: '#475569', marginRight: 4 },
  currencyField: { flex: 1, minHeight: 50, paddingHorizontal: 8, fontSize: 16, color: '#0f172a' },
  dateButton: { minHeight: 52, justifyContent: 'center', backgroundColor: '#f8fafc', borderRadius: 10, paddingHorizontal: 14, borderWidth: 1, borderColor: '#cbd5e1' },
  dateButtonText: { fontSize: 16, color: '#0f172a' },
  placeholderText: { color: '#64748b' },
  multilineInput: { minHeight: 92, textAlignVertical: 'top' },
  reviewNotice: { marginTop: 16, padding: 12, borderRadius: 10, backgroundColor: '#fffbeb', color: '#92400e', fontSize: 12, lineHeight: 18, fontWeight: '700' },
  saveButton: { minHeight: 52, marginTop: 20, borderRadius: 12, backgroundColor: '#4338ca', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16 },
