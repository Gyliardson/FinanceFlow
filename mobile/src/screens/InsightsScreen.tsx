      ...
      <Modal visible={modalVisible} animationType="slide" transparent onRequestClose={closeReserveModal}>
        <KeyboardAvoidingView style={styles.modalOverlay} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          <View style={styles.modalContainer} accessibilityViewIsModal>
            ...
            <View style={styles.inputWrapper}><Text style={styles.currencyPrefix}>R$</Text><TextInput style={styles.modalInputAmount} keyboardType="numeric" placeholder="0,00" placeholderTextColor="#64748b" value={reserveAmount} onChangeText={handleAmountChange} editable={!submittingReserve && !intentLocked && !refreshingAI && !reconcilingSnapshot} accessibilityLabel="Valor a guardar na reserva de emergência" /></View>
