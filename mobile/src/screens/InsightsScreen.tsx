...
export default function InsightsScreen({ navigation }: any) {
  ...
  const handleSaveGoal = async () => {
    if (submittingGoal || !newGoal) return;
    ...
    return (
      <View style={styles.stateContainer} accessibilityLiveRegion="assertive">
        ...
        <TouchableOpacity
          ...
          accessibilityLabel="Tentar carregar os insights novamente"
        >
...
const styles = StyleSheet.create({
  ...
  retryButton: { minHeight: 48, marginTop: 20, paddingHorizontal: 18, borderRadius: 12, backgroundColor: '#4f46e5', flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center' },
  retryButtonText: { color: '#fff', fontWeight: '800' },
  headerCard: { backgroundColor: '#4f46e5', margin: 16, borderRadius: 18, padding: 20, elevation: 4, shadowColor: '#4f46e5', shadowOpacity: 0.3, shadowOffset: { width: 0, height: 4 } },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12, marginBottom: 6 },
  headerLabel: { color: '#e0e7ff', fontSize: 14, fontWeight: '600' },
  balanceText: { color: '#fff', fontSize: 32, fontWeight: '800', marginTop: 4 },
  divider: { height: 1, backgroundColor: '#6366f1', marginVertical: 16 },
  surplusText: { color: '#c7d2fe', fontSize: 22, fontWeight: '700', marginTop: 4 },
  section: { backgroundColor: '#fff', marginHorizontal: 16, marginBottom: 16, borderRadius: 16, padding: 20, elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowOffset: { width: 0, height: 2 } },
  sectionTitle: { flexShrink: 1, fontSize: 16, fontWeight: '700', color: '#1e293b' },
  goalRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 8, marginBottom: 14 },
  goalCopy: { flex: 1 },
  goalText: { fontSize: 14, color: '#334155', fontWeight: '700' },
  savedText: { fontSize: 14, color: '#047857', fontWeight: '800', marginTop: 6 },
  iconButton: { minWidth: 44, minHeight: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#eef2ff' },
  progressBarBg: { height: 12, backgroundColor: '#e2e8f0', borderRadius: 6, overflow: 'hidden', marginBottom: 8 },
  progressBarFill: { height: '100%', backgroundColor: '#10b981', borderRadius: 6 },
  progressText: { fontSize: 12, color: '#047857', fontWeight: '700', textAlign: 'right' },
  insightBox: { backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: 12, padding: 16, marginTop: 8, marginBottom: 16 },
  insightText: { fontSize: 14, lineHeight: 22, color: '#334155' },
  refreshBtn: { minHeight: 48, backgroundColor: '#10b981', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 14, borderRadius: 12, gap: 8 },
  refreshBtnText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  hintText: { fontSize: 12, lineHeight: 18, color: '#64748b', textAlign: 'center', marginTop: 12 },
  addReserveBtn: { minHeight: 44, flexDirection: 'row', alignItems: 'center', backgroundColor: '#10b981', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10, gap: 4 },
  addReserveBtnText: { color: '#fff', fontWeight: '700', fontSize: 12 },
  ...
  modalInputAmount: { flex: 1, padding: 14, fontSize: 15, color: '#1e293b', minHeight: 52 },
  modalActions: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 24, gap: 12 },
  cancelBtn: { flex: 1, minHeight: 48, padding: 14, borderRadius: 12, backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center' },
  cancelBtnText: { color: '#475569', fontWeight: '700' },
  saveBtn: { flex: 2, minHeight: 48, padding: 14, borderRadius: 12, backgroundColor: '#10b981', alignItems: 'center', justifyContent: 'center' },
